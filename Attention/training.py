...
if __name__ == '__main__':
    config = {
        ...
        "model_checkpoint": "best_models/foo2.pckl",
        "lr_step_size": 200

    }

    main(
        fasta="Datasets/generation/unfinished.fasta",
        label_dir="Datasets/generation/labels/random_80_200",
        data_path="/scratch/pytorch_datasets/rbpdist_cnn_test",
        num_threads=1,
        max_length=200,
        config=config,
        seed=0
